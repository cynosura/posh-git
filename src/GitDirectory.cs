namespace PoshGit {
    ...
    public class GitDirectory : VirtualDirectory {
        ...
        GitDirectory(IDirectoryInfo parent, FlattenedSubTree node)
            : base(null, true) {
        ...
        GitDirectory(DirectoryInfo di, FlattenedSubTree node, bool virtualItemsOnly)
            : base(di, virtualItemsOnly) {
            if (node != null) {
